...
// Omit HTML event handlers that framer-motion overrides with incompatible signatures
type MotionConflictingProps = 'onAnimationStart' | 'onDragStart' | 'onDrag' | 'onDragEnd';

export interface ButtonProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, MotionConflictingProps> {
  ...
  ({
    ...
    return (
      ...
      >
        ...
        {/* Content - Hidden when loading but maintains width */}
        <span className={cn(
