...
export const ExportModal: React.FC<ExportModalProps> = ({
  ...
  const handleExport = async () => {
    ...
    onExport({ format, startDate, endDate, includeMetadata: true });
    ...
    >
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <label className="text-xs font-medium text-obsidian-400/70 dark:text-paper-100/70 ml-1 uppercase tracking-wider">
            Format
          </label>
        ...
        <div className="p-3 rounded-lg bg-deep-teal-800/5 dark:bg-white/5 border border-deep-teal-800/10 dark:border-white/10 flex gap-3 items-start">
          ...
          <div className="text-xs text-obsidian-400/70 dark:text-paper-100/70">
            ...
            <span className="font-semibold">{format.toUpperCase()}</span> from{' '}
