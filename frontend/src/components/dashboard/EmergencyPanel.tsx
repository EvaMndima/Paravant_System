...
import {
  AlertTriangle, X, ShieldAlert, Pause, Play,
  Trash2, AlertOctagon, ChevronDown, ChevronUp,
  Search, Zap, Hand, CheckSquare, Square, History,
} from 'lucide-react';
...
export const EmergencyPanel: React.FC<EmergencyPanelProps> = ({ isOpen, onClose }) => {
  ...
  // Suppress unused warning for currentTime (displayed implicitly in header)
  void currentTime;
                        ...
                        >
                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                ...
                                <Badge
                                  ...
                                  size="sm"
                                  className="h-4 px-1 text-[9px] bg-opacity-20 border-opacity-20"
                                >
                                  {pos.side}
                                </Badge>
                              </div>
                          ...
                          <div className="flex items-center gap-6">
                            <div className="text-right hidden sm:block">
                              ...
                              <div className="text-[10px] text-white/40 font-mono">{pos.entry} &rarr; {pos.mark}</div>
                            </div>
                            ...
                            <div className="flex bg-black rounded-lg p-1 border border-white/10">
                              <button
                                ...
                                className={cn(
                                  ...
                                  overrideForm.side === 'BUY' ? 'bg-green-600 text-white' : 'text-white/40 hover:text-white'
                                )}
                              >
                                BUY
                              </button>
                              <button
                                ...
                                className={cn(
                                  'flex-1 py-1.5 rounded text-xs font-bold transition-colors',
                                  overrideForm.side === 'SELL' ? 'bg-red-600 text-white' : 'text-white/40 hover:text-white'
                                )}
                              >
                                SELL
                              </button>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="space-y-2">
                    {mockRecentActions.map((action) => (
                      <div key={action.id} className="flex justify-between items-center p-3 rounded-lg bg-white/5 border border-white/5 text-xs">
                        <div>
                          <div className="font-medium text-white">{action.action}</div>
                          <div className="text-white/40 mt-0.5">
                            {action.reason} &bull; <span className="text-white/30">{action.user}</span>
                          </div>
                        </div>
              ...
              {confirmationAction && (
                ...
                >
                  <div className={cn(
                    ...
                    confirmationAction.type === 'danger' ? 'bg-red-500/20 text-red-500' : 'bg-yellow-500/20 text-yellow-500'
                  )}>
                  ...
                  <p className="text-white/60 text-sm mb-6 max-w-xs">
                    ...
                    <span className={cn(
                      'font-bold mx-1',
                      confirmationAction.type === 'danger' ? 'text-red-400' : 'text-yellow-400'
                    )}>
                  ...
                  <div className="w-full max-w-xs space-y-4">
                    <div className="space-y-1 text-left">
                      <label className="text-[10px] uppercase font-bold text-white/30">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          confirmationAction.type === 'danger'
