"""Manual market regime management for strategy-regime alignment.
...
This module was originally at src/core/strategy/regime.py (a flat module).
It was moved here when the regime/ package was created for automated detection.

Decision: DEC-2026-02-08-003 - Timezone-aware UTC timestamps
Decision: DEC-2026-02-08-008 - Structured logging
MVP Scope: Manual regime tagging only (automated detection in RegimeDetector)
"""
...
class MarketRegime(str, enum.Enum):
    """Market regime classification (manual tagging).

    MVP supports five regimes set manually by the operator.
    Automated macro detection is handled by RegimeDetector (BTC daily EMA).
    """
