    ...
    return (
      <div className={cn("grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", className)}>
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="h-[240px] rounded-2xl overflow-hidden bg-obsidian-400/5 dark:bg-white/5 border border-deep-teal-800/5 dark:border-white/5 p-6 flex flex-col gap-4 animate-pulse">
