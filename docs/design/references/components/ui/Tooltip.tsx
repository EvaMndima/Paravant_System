...
const Tooltip: React.FC<TooltipProps> = ({
  ...
  // Transform styles to center the tooltip relative to the coordinate point
  ...
  // Arrow rotation and positioning styles
          ...
          <AnimatePresence>
            {isVisible && (
              <motion.div
                ...
                className={cn(
                  "pointer-events-none fixed", // Fixed because we calc scroll in top/left but using portal
                )}
              >
                <div
                  className={cn(
