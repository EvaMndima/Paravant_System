...
export interface MetricCardProps {
  ...
  suffix?: string;
  icon?: LucideIcon;
  variant?: 'default' | 'dark' | 'elevated' | 'subtle';
  ...
  ({ 
    ...
    return (
      ...
      >
        ...
        {/* Main Content: Value Left, Trend Right */}
