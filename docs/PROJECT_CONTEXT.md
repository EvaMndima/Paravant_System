...
2. **Capital preservation over return.** The risk layer is the most complete and
   ...
   See Section 4.2.
3. **Decisions are written down.** 132 dated architectural decisions with rationale,
...
└── .claude/ + .agent/        DECISIONS.md (132 decisions, dual-maintained) + rules
```
...
132 dated architectural decisions, 3,462 lines, maintained identically in
