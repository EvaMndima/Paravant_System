...
2. **Capital preservation over return.** The risk layer is the most complete and
   ...
   See Section 4.2.
3. **Decisions are written down.** 136 dated architectural decisions with rationale,
...
└── .claude/ + .agent/        DECISIONS.md (136 decisions, dual-maintained) + rules
```
...
136 dated architectural decisions, 3,567 lines, maintained identically in
